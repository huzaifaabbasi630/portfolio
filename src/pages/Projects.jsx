...
const PROJECTS = [
  ...
  },
  {
    id: 6,
    title: 'HelpHub AI',
    short: 'realtime helping like fiverr but free for all, its a buiding project you can visit my github to see more features',
    desc: 'A full-stack MERN application allowing users to find the best freelancers for their needs. Features include real-time transfer progress with , email notifications, and a clean, modern interface built with Tailwind CSS.',
    ...
    live: 'https://help-hub-ai-frontend.vercel.app/',
    featured: true,
  },
  {
    id: 8,
  ...
  },
  {
    ...
    short: 'AI-powered resume scoring, matching & improvement suggestions interview prepration platform and etc you can visit my github to see more features',
    desc: 'AI Resume Analyzer is a comprehensive platform designed to revolutionize the way job seekers prepare for interviews and optimize their resumes. This full-stack MERN application combines cutting-edge AI with a seamless user interface to provide personalized guidance and instant feedback.',
    ...
    github: ['https://github.com/huzaifaabbasi630/analyzer-backend', 'https://github.com/huzaifaabbasi630/resume-analyzer-frontend'],
    live: 'https://resume-analyzer-frontend-one-omega.vercel.app/',
    featured: true,
  },
  {
    id: 16,
  ...
  {
    id: 17,
    title: 'DevBoard — GitHub Analytics',
    short: 'Real-time GitHub analytics dashboard — enter any username and see live profile stats, top repos & language breakdown',
    desc: 'DevBoard is a full-stack GitHub analytics dashboard built to turn raw GitHub data into a clean, visual story. Enter any GitHub username and instantly see profile stats, top repositories sorted by stars, total stars earned, and a language breakdown chart powered by the GitHub REST API. The backend fetches and aggregates live data from GitHub on every search, while the frontend renders it through smooth animated cards and charts — a self-contained tool that doubles as a live demo of API integration and data visualization skills.',
    ...
    live: 'https://githubdevboard.vercel.app/',
    featured: true,
  },
  {
    id: 18,
    title: 'SnapURL — Smart URL Shortener',
    short: 'A micro-SaaS URL shortener with custom backhalves, QR codes, and real-time click analytics by device, browser & location',
    desc: 'SnapURL is an advanced URL shortening micro-SaaS application that converts long URLs into short, memorable links — complete with a full analytics dashboard. Users can claim custom short codes, generate QR codes instantly for sharing, and track every click in real time with breakdowns by device, browser, and geographic location. The backend runs on Redis-first caching via Upstash for sub-millisecond redirects, while the frontend renders analytics through interactive charts built with Recharts. Built as a fully serverless microservice architecture with separate frontend and backend deployments, SnapURL demonstrates production-grade performance optimization, secure API design, and real-world SaaS product thinking.',
...
.pj-upload-hint span { font-size:12px; font-weight:700; color:rgba(255,255,255,.8); letter-spacing:.08em; }
...
.pj-modal-watch-demo {
  ...
  background: rgba(255,255,255,.8); border: 1px solid rgba(var(--ca),.5);
